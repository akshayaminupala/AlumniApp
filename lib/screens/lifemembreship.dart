...
class LifeMembership extends StatefulWidget {
  static const String id = 'lifemembership';
  @override
  _LifeMembershipState createState() => _LifeMembershipState();
}

class _LifeMembershipState extends State<LifeMembership> {
  @override
