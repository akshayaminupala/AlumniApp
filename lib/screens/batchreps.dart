...
class BatchRep extends StatefulWidget {
  static const String id = 'batchreps';
  @override
  _BatchRepState createState() => _BatchRepState();
}

class _BatchRepState extends State<BatchRep> {
  @override
